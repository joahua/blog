...
class organize extends photostack {
	...
	function addAlbum() {	
		if($_POST['edit'] == 'yes' && $_POST['albumFolder'] != '' && $_POST['albumTitle'] != '') {
			...
			<p>
			<strong><label for="albumTitle">Title:</label></strong>
			<input type="text" name="albumTitle" id="albumTitle" size="35" value"'.$_GET['albumTitle'].'" />
			</p>
			
			<p>
			<strong><label for="albumFolder">Directory Name:</label></strong>
			<input type="text" name="albumFolder" id="albumFolder" size="25" value"'.$_GET['albumFolder'].'" />
			</p>';
			...
			<ul class="centerPlain">
				...
				<li style="height: 50px;">
					<p><strong><$PSAlbumTitle$></strong> - 
						...
						<input type="checkbox" name="delete[]" value="<$PSAlbumFolder$>" id="<$PSAlbumFolder$>" /> <label for="<$PSAlbumFolder$>">Delete</label>
	...
	function editAlbum() {
		...
		if($_GET['edit'] == 'yes' && $_GET['albumFolder'] != '' or $_GET['albumTitle'] != '' or $_GET['albumDate']) {
			...
			<p><strong><label for="albumTitle">Title:</label></strong> <input type="text" name="albumTitle" id="albumTitle" size="20" /></p>
			<p><strong><label for="albumFolder">Directory Name:</label></strong> <input type="text" name="albumFolder" id="albumFolder" size="20" /></p>
			
			<p><strong><label for="albumDate">Date:</strong> <input type="text" name="albumDate" id="albumDate" size="20" /></p>
	...
	function editDesc() {
		...
		if($_GET['edit'] == 'yes') {
			...
			<PSPhotos><li id="photo<$PSPhotoFilename$>" style="height:<$PSPhotoThumbHeight$>px"><a href="#photo<$PSPhotoFilename$>" onClick="window.open(\'<$PSPhotoPath$>\',\'mywindow\',\'width=<$PSPhotoWidth$>,height=<$PSPhotoHeight$>\')" ><img 
					...
					alt="<$PSPhotoFilename$>" /></a><p><strong><label for="<$PSPhotoFilename$>"><$PSPhotoFilename$></label></strong><br />
					<input type="hidden" name="photos[]" value="<$PSPhotoFilename$>" />
					<input type="text" name="desc[]" size="26" value="<$PSPhotoDescription$>" id="<$PSPhotoFilename$>" />
		...
		if($_GET['edit'] == 'yes' && $_GET['delete']) {
			...
			<PSPhotos><li style="height: <$PSPhotoThumbHeight$>px;">
				...
				<p>
					...
					<input type="checkbox" name="delete[]" value="<$PSPhotoFilename$>" id="<$PSPhotoFilename$>" /> <label for="<$PSPhotoFilename$>">Delete</label>
				</p>
			</li></PSPhotos>
			</ol>
